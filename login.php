...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Creative Coder Shopping</title>
...
<body>
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="index.html"><h4>Creative Coder Shopping Site<h4></a>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form action="" class="row login_form" action="" method="post" id="contactForm" novalidate="novalidate">
	...
	<!-- start footer Area -->
	<footer class="footer-area section_gap"> add order module in admin pan
